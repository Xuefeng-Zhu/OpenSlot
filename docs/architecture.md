...
| `PATCH/DELETE /api/settings` | Strict, one-section-at-a-time display/notification updates and account deletion; email mutation fails closed with `EMAIL_UPDATE_UNAVAILABLE` | `src/app/api/settings/route.ts` |

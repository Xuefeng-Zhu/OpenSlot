...
DECLARE
  ...
  demo_schedule_id UUID := 'a83f3c8d-2d6f-49b5-86ad-8f7e3c8c1f4a';
...
BEGIN
  ...
  -- 5. Create weekday availability rules (Monday-Friday, 9:00-17:00)
  -- Weekday mapping: 0=Sunday, 1=Monday, 2=Tuesday, 3=Wednesday, 4=Thursday, 5=Friday, 6=Saturday
  INSERT INTO availability_rules (user_id, schedule_id, weekday, start_time, end_time, timezone, is_active)
  VALUES
    (demo_profile_id, demo_schedule_id, 1, '09:00', '17:00', 'America/New_York', true),
    (demo_profile_id, demo_schedule_id, 2, '09:00', '17:00', 'America/New_York', true),
    (demo_profile_id, demo_schedule_id, 3, '09:00', '17:00', 'America/New_York', true),
    (demo_profile_id, demo_schedule_id, 4, '09:00', '17:00', 'America/New_York', true),
    (demo_profile_id, demo_schedule_id, 5, '09:00', '17:00', 'America/New_York', true);

  -- 6. Create a sample confirmed booking (tomorrow at 10:00-10:30 AM Eastern)
